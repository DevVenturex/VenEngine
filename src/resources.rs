...
use futures::io::{BufReader as FuturesBufReader, Cursor as FuturesCursor};
use log::info;
...
pub async fn load_model(
    ...
    let (models, obj_materials) = tobj::futures::load_obj_buf(
        ...
        |p| async move {
            ...
            tobj::futures::load_mtl_buf(&mut FuturesBufReader::new(FuturesCursor::new(mat_text))).await
        },
    ).await?;
